...
export default function Card({id,kanji,readings}) {
  ...
  return(
    <>
      <div className="mb-6 mx-2" onClick={()=>isToggleOn()}>
        <div className={`${toogle ? 'w-44 h-[12rem] bg-white rounded-xl border-8 border-[#C2E0E8]  justify-center' : 'w-44 h-[12rem] bg-[#C2E0E8] rounded-xl py-6 top-0'} flex cursor-pointer select-none hover:scale-[1.1] hover:rotate-[-8deg]`}>
          {toogle ? (
            <h2 className="text-[#58A9D2] text-7xl self-center font-body">{kanji}</h2>
              ...
              <button className="flex flex-col justify-around text-center mx-auto">
                ...
                {/* <Link href={'../details/'+id} target="_blank">
                  <p className="text-[#58A9D2] w-fit border-b-2 border-[#58A9D2] text-sm mx-auto font-body">由来・語源</p>
                </Link> */}
